...
/**
 * Minimal SMTPS (implicit SSL) mailer for Gmail App Password / Namecheap SMTP.
 */
function send_smtp_mail(string $toCsv, string $subject, string $html, string $text, ?string $replyTo = null): void
{
    ...
    $expect = static function ($fp, array $codes) use (&$readAll): string {
        $data = '';
...
{
    return env('MAIL_TO', 'info@carlmanuel.com,carllouismanuel09@gmail.com') ?? '';
}
